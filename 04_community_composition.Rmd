...
**Number of Bacteria phyla in natural ponds**
...
**Number of Bacteria phyla in protected ponds**
...
**Number of Bacteria phyla in urban ponds**
...
**Number of Archaea phyla in natural ponds**
...
data.frame(physeq_sample_filt@tax_table) %>% 
  ...
  unique()
```
**Number of Archaea phyla in protected ponds**
...
**Number of Archaea phyla in urban ponds**
