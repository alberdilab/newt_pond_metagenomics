...
structural_zeros %>%
  ...
  #mutate(genus = factor(genus, levels = genus))#convert TJ1 genome counts to negative
    ggplot(., aes(x=average, y=forcats::fct_rev(genus), fill=phylum)) +
  geom_col()+
...
## Enrichment analysis between Domestic/Feral
...
```{r ancom_phylum_type, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
#### Type of pond
ancom_rand_output_phyl_type = ancombc2(data = physeq_genome_filtered, 
                  assay_name = "counts", 
